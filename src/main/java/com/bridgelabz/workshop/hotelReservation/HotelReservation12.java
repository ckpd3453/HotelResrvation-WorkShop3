...
public class HotelReservation12 {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= 3; i++) {
			...
			ReservationFunctions12.addHotel(hotelName, weekDayRatesRegular,weekEndRatesRegular, weekDayRatesRewards, weekEndRatesRewards, rating);
		}
		ReservationFunctions12.showHotel();
		...
		String ed = sc.next();
		ReservationFunctions12.findCheapestHotel(sd, ed);
		ReservationFunctions12.getCheapestBestRatedHotel(sd, ed);
		ReservationFunctions12.getBestRatedHotel(sd, ed);
		ReservationFunctions12.getCheapestBestRatedHotelForRewards(sd, ed);
	}
}
